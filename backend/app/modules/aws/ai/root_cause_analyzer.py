...
class AwsRootCauseAnalyzer:
    ...
    def create_fallback_diagnosis(self, error: str | None = None) -> DiagnosisResult:
        ...
        tips = [
            ...
            "Confirm network/IAM access for the LLM endpoint",
        ]
        if fallback:
        ...
        return DiagnosisResult(
            ...
            summary=(
                "AWS evidence was collected successfully, but the AI provider "
                "could not complete reasoning. Collected AWS data is still available."
            ),
            evidence=[],
            suggested_fix=(
